...
pub(in crate::tui::ui) fn render_composer(
    ...
    let border_color = if state.is_composing() { Color::LightRed } else { Color::LightBlue };
...
fn mention_picker_lines(
    ...
    candidates
        ...
        .map(|(index, entry)| {
            ...
            Line::from(vec![
                Span::styled(cursor, Style::default().fg(Color::LightRed)),
...
pub(in crate::tui::ui) fn emoji_picker_lines(
    ...
    candidates
        ...
        .map(|(index, entry)| {
            ...
            let mut spans = vec![Span::styled(cursor, Style::default().fg(Color::LightRed))];
