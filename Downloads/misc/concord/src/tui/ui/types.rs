...
pub(super) const DIM: Color = Color::Gray;
pub(super) const SCROLLBAR_THUMB: Color = Color::Red;
...
pub(super) const SELECTED_FORUM_POST_BORDER: Color = Color::Red;
pub(super) const SELECTED_MESSAGE_BORDER: Color = Color::Red;
